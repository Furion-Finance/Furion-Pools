...
contract ERC20PermitWithMultipleMinters is ERC20Permit, OwnableWithoutContext {
    ...
    ) ERC20(name, symbol) ERC20Permit(name) OwnableWithoutContext(msg.sender) {
     ...
     */
    function mint(address _account, uint256 _amount) internal validMinter(_msgSender()) {
     ...
     */
    function burn(address _account, uint256 _amount) internal validBurner(_msgSender()) {
